...
function updateGameOptionsForGeneration(gen) {
    ...
    // Update Pokemon names and evolution lines for preview
    if (typeof updatePokemonNamesForGeneration === 'function') {
...
function selectGeneration(gen) {
    ...
    // Update Pokemon names and evolution lines for the selected generation
    if (typeof updatePokemonNamesForGeneration === 'function') {
        updatePokemonNamesForGeneration(gen);
    }
    if (typeof updateEvolutionLinesForGeneration === 'function') {
...
async function addFailedEncounter() {
    ...
    // NEW: Validate Pokemon are from correct generation
...
// Add both Pokemon as a soul link pair
...
// All other functions remain the same but are included for completeness...
